   ...
   <div class="container">
      <div class="row align-items-center">
         <div class="col-lg-6">
            ...
            <div class="icon-box">
               <div class="icon">
               	<img src="<?php echo base_url()?>images/diverse-range-of-commodities.png" class="img-fluid">
               </div>
            ...
            <div class="icon-box">
               <div class="icon">
               	<img src="<?php echo base_url()?>images/exceptional-customer-support.png" class="img-fluid">
               </div>
