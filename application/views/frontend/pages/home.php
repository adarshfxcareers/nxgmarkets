        ...
        <div class="row align-items-center banner-sec">
          <div class="col-md-6">
            <div class="banner-content-pointers">
              ...
              <ul class="banner-ul">
                <li>
                  <img src="<?php echo base_url();?>images/meet-deposite-and-volume-targets.png" class="img-fluid">
          ...
          <div class="col-md-6">
            <img src="<?php echo base_url();?>images/slide1.png" class="img-fluid">
          </div>
        </div>
      </div>
    </div>
    <div class="carousel-item">
      <div class="container">
        <div class="row align-items-center banner-sec">
          ...
          <div class="col-md-6">
            <img src="<?php echo base_url();?>images/slide2.png" class="img-fluid">
          </div>
        </div>
      </div>
    </div>
    <div class="carousel-item">
      <div class="container">
        <div class="row align-items-center banner-sec">
          ...
          <div class="col-md-6">
            <img src="<?php echo base_url();?>images/slide3.png" class="img-fluid">
          </div>
        </div>
      </div>
    </div>
    <div class="carousel-item">
      <div class="container">
        <div class="row align-items-center banner-sec">
          ...
          <div class="col-md-6">
            <img src="<?php echo base_url();?>images/slider4.png" class="img-fluid">
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="tab-content" id="myTabContent">
            <div class="tab-pane accordion-item fade show active" id="Forex" role="tabpanel" aria-labelledby="Forex-tab">
              ...
              <div id="collapseForex" class="accordion-collapse collapse show" aria-labelledby="headingForex" data-bs-parent="#myTabContent">
                <div class="accordion-body">
                  ...
                  <p>GBP/USD</p>
                  <p>AUD/USD</p>
                  <p><a href="<?php echo base_url();?>forex">See all instruments <i class="fa fa-angle-right"></i></a></p>
                </div>
              </div>
            </div>
            <div class="tab-pane accordion-item fade" id="Commodities" role="tabpanel" aria-labelledby="Commodities-tab">
              ...
              <div id="collapseCommodities" class="accordion-collapse collapse d-md-block" aria-labelledby="headingCommodities" data-bs-parent="#myTabContent">
                ...
                <p>BRENT (Crude Oil)</p>
                <p>NGAS (Natural Gas)</p>
                <p><a href="<?php echo base_url();?>commodities">See all instruments <i class="fa fa-angle-right"></i></a></p>
                </div>
              </div>
            </div>
            <div class="tab-pane accordion-item fade" id="Indices" role="tabpanel" aria-labelledby="Indices-tab">
              ...
              <div id="collapseIndices" class="accordion-collapse collapse d-md-block" aria-labelledby="headingIndices" data-bs-parent="#myTabContent">
                ...
                <p>FTSE 100 (UK)</p>
                <p>DAX 30 (Germany)</p>
                <p><a href="<?php echo base_url();?>indices">See all instruments <i class="fa fa-angle-right"></i></a></p>
                </div>
              </div>
            </div>
            <div class="tab-pane accordion-item fade" id="Crypto" role="tabpanel" aria-labelledby="Crypto-tab">
              ...
              <div id="collapseCrypto" class="accordion-collapse collapse d-md-block" aria-labelledby="headingCrypto" data-bs-parent="#myTabContent">
                ...
                <p>Ripple (XRP)</p>
                <p>Litecoin (LTC)</p>
                <p><a href="<?php echo base_url();?>cryptocurrencies">See all instruments <i class="fa fa-angle-right"></i></a></p>
                </div>
              </div>
            </div>
            <div class="tab-pane accordion-item fade" id="Stocks" role="tabpanel" aria-labelledby="Stocks-tab">
              ...
              <div id="collapseStocks" class="accordion-collapse collapse d-md-block" aria-labelledby="headingStocks" data-bs-parent="#myTabContent">
                ...
                <p>Ripple (XRP)</p>
                <p>Litecoin (LTC)</p>
                <p><a href="<?php echo base_url();?>stocks">See all instruments <i class="fa fa-angle-right"></i></a></p>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="row">
      <div class="col-lg-6 copytrade-left">
        ...
        <div class="multiple-buttons">
          ...
          <a href="<?php echo base_url();?>copytrading" class="theme-bttn"><i class="fa fa-angle-right" aria-hidden="true"></i>Learn More</a>
        </div>
      </div>
      <div class="col-lg-6">
        <img src="<?php echo base_url();?>images/copy-trading-scaled.webp" class="img-fluid">
      </div>
    </div>
  </div>
</section>
      ...
      <div class="col-md-6">
        <div class="mt-icon-boxx">
          ...
          <div class="d-flex align-items-center justify-content-between">
            ...
            <a href="<?php echo base_url();?>mt5"> <i class="fa fa-angle-right text-primary" aria-hidden="true"></i> </a>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    <div class="row g-4 align-items-center">
      <div class="col-lg-6   text-center order-lg-1 order-2">
        <img src="<?php echo base_url();?>images/autochartist-nxg.png" class="img-fluid" width="80%">
      </div>
        ...
        <div class="owl-carousel owl-carousel11">
          <div>
            <div class="benefits-section">
              <img class="" src="<?php echo base_url();?>images/bc-visa-master.png" alt="">
            </div>
          </div>
          <div>
            <div class="benefits-section">
              <img class="" src="<?php echo base_url();?>images/skrill.png" alt="">
            </div>
          </div>
          <div>
            <div class="benefits-section">
              <img class="" src="<?php echo base_url();?>images/neteller.png" alt="">
            </div>
          </div>
          <div>
            <div class="benefits-section">
              <img class="" src="<?php echo base_url();?>images/bank-transfer.png" alt="">
            </div>
          </div>
          <div>
            <div class="benefits-section">
              <img class="" src="<?php echo base_url();?>images/bitcoin.png" alt="">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row g-4">
      <div class="col-md-6">
        <div class="new-to-forex-trading">
          ...
          <img src="<?php echo base_url();?>images/just-starting.webp" class="img-fluid">
      ...
      <div class="col-md-6">
        <div class="new-to-forex-trading">
          ...
          <img src="<?php echo base_url();?>images/stay-ahead.webp" class="img-fluid">
          <div class="request-quote">
            <a href="https://my.nxgmarkets.com/auth/register" class="theme-btn theme-btn2">Learn More</a>
          </div>
        </div>
