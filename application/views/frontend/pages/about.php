...
<section class="powered_by_trading">
   <div class="container">
      <div class="row align-items-center">
         <div class="col-md-6">
            <img src="<?php echo base_url()?>images/about-nxg.png" class="img-fluid">
         </div>
         <div class="col-md-6">
            <h2 class="text-primary ">
      ...
      <div class="row mt-5 gy-4 justify-content-center text-center">
         <div class="col-lg-4">
            <div class="main-feature">
               <figure>
                  <img src="<?php echo base_url()?>images/integrity.png" class="img-fluid">
               </figure>
         ...
         <div class="col-lg-4 col-md-6">
            <div class="main-feature">
               <figure>
                  <img src="<?php echo base_url()?>images/client-centric-approach.png" class="img-fluid">
               </figure>
               <div class="feature-content">
                  <h4 class="text-primary ">
         ...
         <div class="col-md-6 col-lg-4">
            <div class="main-feature">
               <figure>
                  <img src="<?php echo base_url()?>images/innovation.png" class="img-fluid">
               </figure>
               <div class="feature-content">
                  <h4 class="text-primary ">
                     Innovation
         ...
         <div class="col-md-6 col-lg-4">
            <div class="main-feature">
               <figure>
                  <img src="<?php echo base_url()?>images/knowledge-sharing.png" class="img-fluid">
               </figure>
               <h4 class="text-primary ">
                  Knowledge Sharing
               </h4>
         ...
         <div class="col-md-6 col-lg-4">
            <div class="main-feature">
               <figure>
                  <img src="<?php echo base_url()?>images/trust-and-reliability.png" class="img-fluid">
               </figure>
               <h4 class="text-primary ">
