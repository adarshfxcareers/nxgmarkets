...
if (is_numeric($page_name)) {
   $seo_data = $this->db->get_where('blogdata', array('id' => $page_name))->result_array();
} else {
                                       ...
                                       <div class="row">
                                          <div class="col-lg-12 px-0">
                                             <ol class="list-unstyled row gx-0 mx-0 mb-3 drop-inner-links">
                                                ...
                                                <li class="col-12 mb-2">
                                                   <a href="<?php echo base_url(); ?>refer-and-shop">Refer and Shop</a>
                                                </li>
                                             </ol>
                                          </div>
                                       </div>
               ...
               <ul class="mobile-menu-list">
                  <li>
                     ...
                     <div class="dropdown-mb-menu">
                        <ul>
                           <li>
                              <a href="<?php echo base_url(); ?>accounttype">Account Types</a>
                           </li>
                           <li>
