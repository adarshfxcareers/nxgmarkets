...
<head>
    ...
    <!-- for table design -->
    <link rel="stylesheet"
        href="<?php echo base_url(); ?>admintheme/assets/plugins/jquery-datatable/dataTables.bootstrap4.min.css">
    <!-- Custom Css -->
...
<body class="theme-cyan">
    ...
    <script
        src="<?php echo base_url(); ?>/admintheme/assets/plugins/jquery-datatable/buttons/dataTables.buttons.min.js"></script>
    <script
