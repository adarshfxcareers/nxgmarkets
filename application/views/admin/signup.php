						...
						<div class="card shadow-none bg-transparent shadow-none rounded-0 mb-0">
							<div class="card-body p-sm-0">
								<img src="<?php echo base_url(); ?>images/affiliiate.webp"
									class="img-fluid auth-img-cover-login" width="1150" alt="" />
							</div>
						</div>
					</div>
					<div class="col-12 col-xl-4 col-xxl-4 auth-cover-right align-items-center justify-content-center">
						<div class="card rounded-0 m-1 shadow-none bg-transparent mb-0">
							<div class="card-body p-sm-1">
								<div class="">
									<div class="mb-3 text-center p-sm-1">
										<img src="<?php echo base_url(); ?>images/nxg-logo.png" width="280" alt="" />
									</div>
									...
									<div class="form-body">
										...
										<div class="col-6 form-group">
											...
											<input type="text" class="form-control" id="first_name" name="first_name"
												value="<?php echo $this->session->userdata['singup_first_name']; ?>"
												placeholder="Jhon">
										</div>
										<div class="col-6 form-group">
											<label for="inputUsername" class="form-label">Last Name</label>
											<input type="text" class="form-control" id="last_name" name="last_name"
												value="<?php echo $this->session->userdata['singup_last_name']; ?>"
												placeholder="Jhon">
										</div>
										<div class="col-6 form-group">
											<label for="inputUsername" class="form-label">Mobile Number</label>
											<input type="text" class="form-control" id="mobile" name="mobile"
												value="<?php echo $this->session->userdata['singup_mobile']; ?>"
												placeholder="mobile">
										</div>
										<div class="col-6 form-group">
											<label for="inputEmailAddress" class="form-label">Email Address</label>
											<input type="email" class="form-control" id="email_id" name="email_id"
												value="<?php echo $this->session->userdata['singup_email']; ?>"
										...
										<div class="col-6 form-group">
											...
											<div class="input-group" id="show_hide_password">
												<input type="password" class="form-control border-end-0" id="password"
													name="password"
													value="<?php echo $this->session->userdata['singup_password']; ?>"
										...
										<div class="col-6 form-group">
											...
											<div class="input-group" id="show_hide_password">
												<input type="password" class="form-control border-end-0"
													id="inputMatchPassword" name="inputMatchPassword"
													value="<?php echo $this->session->userdata['singup_password_match']; ?>"
													placeholder="Enter Password">
											</div>
										</div>
										<!-- <div class="col-6">
										...
										<div class="col-12 form-group">
											...
											<select class="form-select form-control" id="inputSelectCountry"
												name="inputSelectCountry" aria-label="Default select example">
												<option selected>
													<?php echo $this->session->userdata['singup_country']; ?>
												</option>
										...
										<!-- OTP Block -->
										<?php if ($this->session->userdata['singup_otp'] == "") { ?>
											<div class="collapse" id="collapseExample"><?php } ?>

											<div class="col-12 form-group" name="OTPx" id="OTPx">
												<label> Enter OTP sent via email </label>
												<input type="text" name="OTP" id="OTP" class="form-control"
													placeholder="Enter OTP send via email">
												<input type="hidden" id="OTP1" name="OTP1"
													value="<?php echo $this->session->userdata['singup_otp']; ?>" />
												<div class="text-black" id="message1"> </div>
											</div>
										...
										<div class="col-12">
											<div class="text-center ">
												<p class="mb-0">Already have an account? <a
														href="<?php echo base_url() ?>admin">Sign in here</a></p>
											</div>
										</div>
										</form>
									</div>
